...
@Service
public class PriceUpdateByDiscountPercentServiceImpl implements PriceUpdateService {
    ...
    public Optional<Product> updatePrice(long productId, BigDecimal value) {
        ...
        BigDecimal multiplicand = BigDecimal.ONE.subtract(value.divide(BigDecimal.valueOf(100), new MathContext(2)));
    ...
    public PriceUpdateCategory getPriceUpdateCategory() {
        return PriceUpdateCategory.DISCOUNT_PERCENTAGE;
    }
}
